...
echo ""
echo "🔍 실험 결과 분석 가이드:"
echo "   ✅ 각 실험의 언어별 성능 비교"
echo "   ✅ Cross Entropy vs Focal vs BCE 손실 함수 효과"
echo "   ✅ SAM 옵티마이저의 언어별 일반화 성능"
echo "   ✅ 불균형 데이터에 대한 각 손실 함수의 효과"
echo ""
echo "📊 결과 확인 방법:"
echo "   - 각 실험 폴더의 콘솔 출력에서 언어별 분석 확인"
echo "   - wandb 대시보드에서 실험별 언어별 메트릭 비교"
echo "   - ROC 곡선과 Confusion Matrix로 시각적 비교"
echo "   - 최적 threshold의 실험별/언어별 차이 분석"
